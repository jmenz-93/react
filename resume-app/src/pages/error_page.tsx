...
export function ErrorPage() {
  return (
    <div className="flex flex-col items-center justify-center min-h-[60vh] px-6 py-24 sm:py-32 lg:px-8 text-center">
      <div className="rounded-full bg-red-100/60 p-4 mb-6">
      ...
      <div className="mt-10 flex items-center justify-center gap-x-6">
        <Link
          ...
          className="rounded-full bg-slate-900 px-6 py-3 text-sm font-semibold text-white shadow-sm hover:bg-slate-700 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-slate-600 transition-all hover:scale-105"
        >
          Go back home
        </Link>
      </div>
